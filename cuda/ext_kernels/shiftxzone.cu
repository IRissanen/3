...
shiftxzone(float* __restrict__  dst, float* __restrict__  src,
       int Nx,  int Ny,  int Nz, int shx, int shy, int shz, float clampL, float clampR, float* __restrict__ zoneGeom) {
